...
REQUIRED_RESEARCH_FILES = {
    ...
    "frontend/src/api/researchCandidates.ts",
    "frontend/src/api/researchStudyActivity.ts",
    "frontend/src/api/researchShortlist.ts",
    "frontend/src/api/researchComparisons.ts",
    "frontend/src/api/researchDecisions.ts",
    "frontend/src/api/researchTradeChart.ts",
    "frontend/src/components/research/SavedTradeChart.tsx",
    "frontend/src/components/research/SavedTradeChartDialog.tsx",
    "frontend/src/components/research/savedTradeChartFeed.ts",
    "frontend/src/components/research/savedTradeIndicators.ts",
    "frontend/src/components/research/ResearchShortlist.tsx",
    "frontend/src/components/research/ResearchComparisons.tsx",
    "frontend/src/components/research/ResearchDecisions.tsx",
    "frontend/src/components/research/CandidateDecision.tsx",
    "frontend/src/components/research/DecisionEvidence.tsx",
    "frontend/src/components/research/ShortlistCompare.tsx",
    "frontend/src/components/research/ReportCurrency.tsx",
    "frontend/src/components/research/SaveToShortlist.tsx",
    "frontend/src/components/research/StudyActivity.tsx",
    "frontend/src/components/research/PortfolioStudyWorkspace.tsx",
    "frontend/src/components/research/studyPresentation.ts",
    "frontend/src/components/research/studyTrialView.ts",
    "frontend/src/components/research/useStudyWorkspaceView.ts",
    "services/research_candidates.py",
    "services/research_study_activity.py",
    "services/research_shortlist.py",
    "services/research_comparisons.py",
    "services/research_decisions.py",
    "services/research_trade_chart.py",
    ...
    "services/research_setup_reuse.py",
    "services/research_validation.py",
    ...
    "research/market_series.py",
    "research/regimes.py",
    "research/market_conditions.py",
    "research/condition_replay.py",
    ...
    "services/research_benchmarks.py",
    "services/research_market_series.py",
    "services/research_regimes.py",
    "services/research_condition_replay.py",
