...
calculations. The subsequent [activity receipt](REPORT_EXPERIENCE_PLAN.md#16-durable-study-activity--12-september-2026)
records durable outcomes, failures and recovery history. R5 now builds on those
candidate identities with [saved shortlists and fair comparisons](REPORT_EXPERIENCE_PLAN.md#19-saved-fair-comparisons--12-september-2026).
Append-only decisions, explicit report openings and existing later-evidence links
now complete the bounded comparison-to-choice loop. Next connect validation
launch to the original candidate reservation and chosen setup; see the
[decision receipt](REPORT_EXPERIENCE_PLAN.md#20-saved-decisions-and-evidence-use--12-september-2026).
...
| Research records | Named experiments, server drafts, immutable setup versions, search/notes/tags/pins, linked runs, saved shortlist/comparisons, append-only decisions and explicit frozen-report openings, archive/restore | Chosen setup/validation launch, ordinary report-wide opening history and complete last-view restoration | C/H for core library plus controlled R5 shortlist/comparison/decision journey; remaining R5/M1 add the missing links |
| Results | Continuous report/risk depth, account-saved preferences, month/drawdown investigation, exact report identities, native statistics, trial settings/Columns, frozen replay and saved comparison | Native benchmark, complete context restoration and portable presentation export | C/H plus bounded controlled-engine/browser R0–R2/R5 receipts; broader normal-account acceptance pending |
| Trial evidence | Original proposals/repeats, sortable distinct/all-proposal views, scalar analysis, connected native Optuna figures, exact reports, durable activity/failure capture and shortlist | Full view restoration and broader runtime/owner acceptance | C/H plus controlled connected-journey observation; absent old observations stay unknown; report R4/R5/M3 extend the contract |
...
| Interface | Native React, continuous report, study/activity workspace, shortlist/comparisons, library navigation, server autosave/preferences/conflict recovery and compact progress | Contextual data views and full navigation restoration | C/H and bounded report/study/comparison desktop/mobile receipts; broader ordinary-account acceptance pending |
...
| J13 Explore parameters | C/H native plots, configurable trials, exact reports and saved shortlist; durable failure/activity and recovery observed on controlled data | M3.2/M5.2 / report R4 | Original trial identity and evidence are retained; broader acceptance and full view restoration remain |
...
| J17 Shortlist | C/O bounded native shortlist | M1/M3.5 / report R5 | Exact candidate/settings retained across visits; ownership, archive and prepared-report boundaries observed |
| J18 Compare | C/O bounded saved 2–4 report comparisons | M4a.1 / report R5 | Original report/analysis versions retained; mismatch blocks deltas/overlay; decisions and broader acceptance remain |
...
| J28 Retain/reject | C/O bounded comparison-member decisions | M4a.3 / report R5 | Keep/Reject/Revisit, reason, original evidence and append-only revisions observed; chosen reusable setup/handoff remains |
...
| Connected study exploration | Overview/Parameters/Trials/Activity, real chart-to-candidate links and original-preserving reports now work. Durable activity records actual outcomes and interruptions without changing scientific replay. Finish broader acceptance, exact scroll/zoom and cross-device study context | **Implemented bounded R4 slices:** [latest receipt](REPORT_EXPERIENCE_PLAN.md#16-durable-study-activity--12-september-2026); shortlist/decisions now proceed through R5 |
| Candidates, comparison and decisions | Exact candidate reports, server-saved shortlists and frozen comparisons of 2–4 ready reports now work, including reference selection, notes, archive and version retention. Append-only Keep/Reject/Revisit choices now retain exact supporting reports and reasons, separate from the objective winner | **R5 decision slice implemented:** [receipt](REPORT_EXPERIENCE_PLAN.md#20-saved-decisions-and-evidence-use--12-september-2026). Next canonical comparison-to-validation launch and chosen setup link, then first complete release: R5 / M4a.1/M4a.3 |
| Reserved-period evaluation | Frozen reservation, chosen-candidate evaluation, exact test-condition descriptors and saved comparison now work. Existing exact later results can be attached to decisions with explicit openings and recorded calculation overlap. Finish comparison-to-validation launch and ordinary report-wide history; repeated exposure must not be described as untouched | **Now, contract implemented first:** remaining R0/R5 / M2.3/M4a.2. The new path preserves legacy both-period reports and their evidence |
