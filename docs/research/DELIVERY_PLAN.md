...
Decisions and evidence-use history are the next dependent increment.
...
| Research records | Named experiments, server drafts, immutable setup versions, search/notes/tags/pins, linked runs, saved shortlist/comparisons, archive/restore | Decisions, evidence-use history and complete last-view restoration | C/H for core library plus controlled R5 shortlist/comparison journey; remaining R5/M1 add the missing records |
...
| Candidates, comparison and decisions | Exact candidate reports, server-saved shortlists and frozen comparisons of 2–4 ready reports now work, including reference selection, notes, archive and version retention. Next retain Keep/Reject/Revisit decisions and distinguish the objective winner from the user's chosen setup | **R5 comparison slice implemented:** [receipt](REPORT_EXPERIENCE_PLAN.md#19-saved-fair-comparisons--12-september-2026). Decisions and evidence-use history are next, then first complete release: R5 / M4a.1/M4a.3 |
| Reserved-period evaluation | Frozen reservation, chosen-candidate evaluation, exact test-condition descriptors and saved comparison now work. Finish visible evidence-use history and saved decisions. Preserve separate reports; repeated exposure must not be described as untouched | **Now, contract implemented first:** remaining R0/R5 / M2.3/M4a.2. The new path preserves legacy both-period reports and their evidence |
