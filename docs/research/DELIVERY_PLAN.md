...
candidate identities: persisted shortlists first, then fair comparison and decisions.
...
| J13 Explore parameters | C/H native plots, configurable trials and exact candidate reports; durable failure/activity and recovery journey observed on controlled data | M3.2/M5.2 / report R4 | Original trial identity and evidence are retained; saved shortlist and broader acceptance remain |
...
| Candidates, comparison and decisions | Exact candidate reports and server-saved baseline/trial shortlists now work, including notes, archive rules and reference retention. Next compare baseline plus 2–4 compatible candidates, retain Keep/Reject/Revisit decisions and distinguish the objective winner from the user's chosen setup | **R5 shortlist slice implemented:** [receipt](REPORT_EXPERIENCE_PLAN.md#17-exact-saved-shortlists--12-september-2026). Fair comparison/decisions are next, then first complete release: R5 / M4a.1/M4a.3 |
